...
HID_KEY_CONTROL = HID_KEY_LEFT_CONTROL
HID_KEY_CTRL = HID_KEY_LEFT_CONTROL
HID_KEY_SHIFT = HID_KEY_LEFT_SHIFT
HID_KEY_ALT = HID_KEY_LEFT_ALT
HID_KEY_GUI = HID_KEY_LEFT_GUI
...
SWITCH_HORI_INPUT_MAP = {
    ...
    "xb_left_trigger": ("button", SW_HORI_BUTTON_ZL),
    "xb_right_trigger": ("button", SW_HORI_BUTTON_ZR),
