// Auto-generated from shared/input_schema.json
...
export type GamepadInput =
  ...
  | 'xb_left_stick_up'
  | 'xb_left_stick_down'
  | 'xb_left_stick_button'
  | 'xb_right_stick_left'
  | 'xb_right_stick_right'
  | 'xb_right_stick_up'
  | 'xb_right_stick_down'
  | 'xb_right_stick_button'
  | 'xb_menu'
  | 'xb_view'
  | 'xb_home';
...
export const INPUT_SCHEMA: InputSchema = {
  "version": 1,
  "default_layout": {
    "button_1": "1",
    "button_2": "2",
  ...
  "keyboard": {
    "inputs": {
      ...
      "key_shift": {
        "label": "Shift",
        "category": "Special",
        "keycode": "HID_KEY_SHIFT"
      },
      "key_control": {
        "label": "Control",
        "category": "Special",
        "keycode": "HID_KEY_CONTROL"
      },
      "key_alt": {
        "label": "Alt",
        "category": "Special",
