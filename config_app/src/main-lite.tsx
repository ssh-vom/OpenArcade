...
type LiteBootstrapPhase = "connecting" | "connected" | "error";

function LiteBootstrap() {
    const httpBasePath = import.meta.env.VITE_CONFIG_HTTP_BASE_PATH || "/api";

    const [phase, setPhase] = useState<LiteBootstrapPhase>("connecting");
    const [error, setError] = useState<string | null>(null);
    const [client, setClient] = useState<IConfigClient | null>(null);
